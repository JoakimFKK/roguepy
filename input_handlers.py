...
If an action is returned it will be attempted if it's valid then MainGameEventHandler will become the active handler.
"""
...
class InventoryEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        if number_of_items_in_inventory > 0:
            ...
            console.print(x + 1, y + 1, "(The abyss stares back.)")
